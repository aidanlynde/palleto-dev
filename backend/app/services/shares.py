...
def create_or_get_card_share(db: Session, card: Card) -> CardShare:
...
def build_share_card_image_url(share_token: str) -> str:
    base_url = settings.public_share_base_url or settings.public_api_base_url
    normalized_base_url = base_url.rstrip("/")
    return f"{normalized_base_url}/share/card/{share_token}.png"
